...
void _transactionModelSerialize(
  ...
  writer.writeLong(offsets[4], object.ledgerId);
  writer.writeString(offsets[5], object.notes);
  writer.writeString(offsets[6], object.paidBy);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.ledgerId = reader.readLong(offsets[4]);
  object.notes = reader.readStringOrNull(offsets[5]);
  object.paidBy = reader.readString(offsets[6]);
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByLedgerId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ledgerId', Sort.asc);
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByLedgerIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'ledgerId', Sort.desc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByLedgerId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'ledgerId');
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByPaidBy(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, int, QQueryOperations> ledgerIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'ledgerId');
    });
  }
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> paidByProperty() {
    return QueryBuilder.apply(this, (query) {
